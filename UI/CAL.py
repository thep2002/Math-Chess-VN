...
class CACULATION:
    ...
    def draw_caltable(self, screen,events,IMAGES):
        ...
        title_3 = str(self.cal_num_2) + ' + ' + str(self.cal_num_1) + ' = ' + str(self.cal_num_2 + self.cal_num_1)
        title_4 = str(self.cal_num_2) + ' - ' + str(self.cal_num_1) + ' = ' + str(self.cal_num_2 - self.cal_num_1)
        title_5 = str(self.cal_num_2) + ' * ' + str(self.cal_num_1) + ' = ' + str(self.cal_num_2 * self.cal_num_1)
        if self.cal_num_1 == 0:
        ...
        if self.cal_2 or self.cal_1:
            if self.cal_1:
                ...
                screen.blit(sub_screen2, (WIDTH - WIDTH_CAL+ r * WIDTH_CAL//5, (HEIGHT - HEIGHT_CAL) // 2+140 + c * WIDTH_CAL//5))
            if self.cal_2:
                r = self.cal_num_2 % 5
                c = self.cal_num_2 // 5
                sub_screen2 = pygame.Surface((WIDTH_CAL//5, HEIGHT_CAL//5))
            ...
            if rect.collidepoint(pygame.mouse.get_pos()):
                ...
                screen.blit(sub_screen3, (WIDTH - WIDTH_CAL+ r * WIDTH_CAL//5, (HEIGHT - HEIGHT_CAL) // 2+140 + c * WIDTH_CAL//5))
            ...
            for i in range(4):
                pygame.draw.line(screen,pygame.Color(120, 8, 8),(WIDTH - WIDTH_CAL + WIDTH_CAL//5*(i+1), (HEIGHT - HEIGHT_CAL) // 2 + 140),(WIDTH - WIDTH_CAL + WIDTH_CAL//5*(i+1),(HEIGHT - HEIGHT_CAL) // 2 + HEIGHT_CAL//5*2+ 138),2)
            for r in range(2):
                for c in range(5):
                    piece = self.board[r][c]
                    rect =  pygame.Rect(c * HEIGHT_CAL//5 + 8 +WIDTH - WIDTH_CAL, r * HEIGHT_CAL//5 + 8 +(HEIGHT - HEIGHT_CAL) // 2 + 140, HEIGHT_CAL//5, HEIGHT_CAL//5)
